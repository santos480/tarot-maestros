...
export default function HistorialPanel({ user, session, onVolver }) {
      ...
      <div style={{maxWidth:900,margin:'0 auto'}}>
        ...
        <div style={{marginBottom:40}}>
          <div style={{textAlign:'center',marginBottom:30}}>
            <h1 style={{fontSize:28,margin:'0 0 8px',color:'#c9a84c',fontWeight:300,letterSpacing:5}}>
              LECTURAS
            </h1>
            <p style={{fontSize:11,color:'#9a8f7a',margin:0,letterSpacing:2}}>
